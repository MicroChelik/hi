	...
	<div aria-label="breadcrumb" class="breadcrumbNav">
		<div class="container px-0">
			<ol class="breadcrumb pl-0">
	    		...
	    		<li class="breadcrumb-item active" aria-current="page">Поверка и ремонт дозиметров</li>
		 	</ol>
		</div>
	</div>
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-5">
				<h3 class="newsTitle">Поверка и ремонт дозиметров</h3>
				<p class="newsText">
			...
			<div class="row">
				...
				<div class="col-12 schemes d-lg-flex">
					...
					<div class="col-lg-3 col-12 scheme">
						...
						<div class="col-12 d-flex schemeText">
							<p>По окончании работ Заказчик получает акт выполненных работ и «Свидетельство о поверке»</p>
						</div>
					</div>
				</div>
			</div>
